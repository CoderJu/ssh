...
<div class="container cart">
    <div class="span24">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/product_findById?pid=<s:property  value="#cartItem.product.pid"/>" target="_blank"> <s:property  value="#cartItem.product.pname"/></a>
                </td>
                <td>
        ...
        <div class="bottom">
            ...
            <a href="login.htm" id="submit" class="submit">提交订单</a>
        </div>
    </div>
    </s:if>
    <s:else>
    <div class="span24">
        <div class="step step1">
            <h1 align="center" color="red">购物车为空,请先去购物</h1>
        </div>
    </s:else>
</div>
