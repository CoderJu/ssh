									...
									<tr>
										...
										value="pageBean.totalPage" />页 </span>
												<s:if test="pageBean.page != 1">
													<a
															href="${ pageContext.request.contextPath }/adminOrder_findByState.action?page=1&state=<s:property value="#o.state"/>"
															class="firstPage">&nbsp;</a>
													<a
															href="${ pageContext.request.contextPath }/adminOrder_findByState.action?page=<s:property value="pageBean.page-1"/>&state=<s:property value="#o.state"/>"
															class="previousPage">&nbsp;</a>
												</s:if>
												<s:if test="pageBean.page !=1">
												<a class="lastPage"
													   href="${ pageContext.request.contextPath }/adminOrder_findByState.action?page=1&state=<s:property value="#o.state"/>">首页</a>
												<a class="nextPage"
												   href="${ pageContext.request.contextPath }/adminOrder_findByState.action?page=<s:property value="pageBean.page-1"/>&state=<s:property value="#o.state"/>">上一页</a>
												</s:if>
												<s:if test="pageBean.page != pageBean.totalPage">
												<a class="nextPage"
												   href="${ pageContext.request.contextPath }/adminOrder_findByState.action?page=<s:property value="pageBean.page+1"/>&state=<s:property value="#o.state"/>">下一页</a>
												<a class="lastPage"
												   href="${ pageContext.request.contextPath }/adminOrder_findByState.action?page=<s:property value="pageBean.totalPage"/>">尾页</a>
												</s:if>
											</div>
										</th>
									</tr>
